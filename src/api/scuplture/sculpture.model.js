...
const sculptureSchema = new Schema(
  {
    ...
    img: {type: String, required: true, default: "https://www.ikea.com/images/a-brown-ikea-bag-with-the-word-sculpture-written-on-it-sits--85dc3c7bbe21ed43ccc061424287588f.jpg"},
